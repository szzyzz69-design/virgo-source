...
from app.api.supervisor import create_supervisor_router, mount_supervisor_ui
...
def create_app(
    ...
    def redirect_to_supervisor() -> RedirectResponse:
        return RedirectResponse(url="/supervisor/", status_code=307)
